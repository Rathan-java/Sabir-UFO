...
const SEED_SIGHTINGS = [
  {
    ...
    isPublic: true,
    classification: 'Nocturnal Lights (Glowing lights or ball-shaped UFO seen at night)',
    objectShape: 'Light (just a point or ball of light)',
    witnessCount: 2,
  ...
  },
  {
    ...
    reporterEmail: 'explorer@example.com',
    isPublic: false,
    classification: 'Close Encounter of the First Kind (Saw a UFO up close, no contact)',
    objectShape: 'Disc (saucer-shaped)',
    witnessCount: 1,
  ...
  },
  {
    ...
    reporterEmail: 'explorer@example.com',
    isPublic: true,
    classification: 'Daylight Discs (Disc or saucer-shaped UFO seen in daylight)',
    objectShape: 'Sphere (round / ball)',
    witnessCount: 5,
